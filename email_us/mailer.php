...
$subject = "New message from Moxie.com!";

$message = "

 A customer has sent you a message from Moxie.com!
...
header('Location: http://www.moxiehairanddesignstudio.com');
exit();
